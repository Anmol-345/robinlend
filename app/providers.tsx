...
import { hederaTestnet, robinhoodTestnet } from "@/lib/chain";
...
const config = createConfig({
  chains: [hederaTestnet, robinhoodTestnet],
  multiInjectedProviderDiscovery: true,
  transports: { 
    [hederaTestnet.id]: http(undefined, { batch: { wait: 16 } }),
    [robinhoodTestnet.id]: http(undefined, { batch: { wait: 16 } }),
  },
  ssr: true,
});
